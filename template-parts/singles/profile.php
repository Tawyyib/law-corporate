                                ...
                                while (have_posts()){
                                    ...
                                    <section class="main-post mb-4" >                                        
                                        ...
                                        <main class="person d-flex flex-column" >                                            
                                            ...
                                            <div class="person__meta d-flex flex-column">
                                                    
                                                <span class="<?php echo esc_attr('person__meta-name'); ?>">
                                                    ...
                                                    <?php // Get and display the role or designation
                                                        ...
                                                        if (!empty($honours)){
                                                            ...
                                                            echo '<span class="person__meta-honours">' . esc_html($honours) . '</span>';
                                            ...
                                            <article class="person__profile">

                                                <!-- section thumbnail -->
                                                <div class="person__profile-body">
                                                ...
                                                <!-- section thumbnail -->
                                                <figure class="person__profile-thumbnail">
                                                    ...
                                                    <img src="
                                                        ...
                                                        alt="<?php the_title(); ?>"  
                                                        title="<?php the_title(); ?>" 
                                                        class="person__profile-thumbnail-image" 
                                                    >
                                            ...
                                            <div class="person__socials-links">
